        ...
        <div className="about-factory-content">
          ...
          <div className="about-factory-text-content">
            <p className="about-factory-description">
              ...
              chế biến gỗ đáp ứng hầu hết những  yêu cầu khắc khe và số lượng đơn hàng của khách hàng.
            </p>
            <Link to="/infrastructure" className="about-factory-link">CỞ SỞ SẢN XUẤT</Link>
          </div>
        </div>
      </section>
